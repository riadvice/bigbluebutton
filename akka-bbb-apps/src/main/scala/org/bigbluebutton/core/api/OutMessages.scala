...
case class UserSharedWebcam(meetingID: String, recorded: Boolean, userID: String, stream: String, granted: Boolean) extends IOutMessage
case class UserUnsharedWebcam(meetingID: String, recorded: Boolean, userID: String, stream: String) extends IOutMessage
case class StreamPermissionChange(meetingID: String, recorded: Boolean, userID: String, stream: String, granted: Boolean) extends IOutMessage
